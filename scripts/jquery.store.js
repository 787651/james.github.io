...
(function( jQuery ) {
	...
	jQuery.Shop.prototype = {
		init: function() {
			...
			this.paypalBusinessEmail = "https://www.paypal.com/signin"; // Your Business PayPal's account email address
			this.paypalURL = "https://www.paypal.com/signin"; // The URL of the PayPal's form
